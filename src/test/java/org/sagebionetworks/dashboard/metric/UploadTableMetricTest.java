...
public class UploadTableMetricTest {
    ...
    public void validUploadUri() {
        ...
        Metric<AccessRecord, String> metric = new UploadTableMetric();
    ...
    @Test
    public void validPreviewUri() {
        RecordParser parser = new RepoRecordParser();
        String line = ",\"17\",\"1423611312727\",,\"repo-prod-76-0.prod.sagebase.org\",\"33860\",\"Synpase-Java-Client/2015-01-30-1577-40e5630  Synapse-Web-Client/76.0-2-g5f246c4\",\"domain=SYNAPSE\",\"6a7616fd-9549-432f-9174-8005ba0d5665\",,\"/repo/v1/entity/syn3163713/table/upload/csv/preview/async/start\",\"3323072\",,\"2015-02-10\",\"POST\",\"043ad075351c10aa:4ea2e7a8:14b461f6975:-7ffd\",\"000000076\",\"prod\",\"true\",\"201\"";
        Reader reader = new StringReader(line);
        List<AccessRecord> records = parser.parse(reader);
        assertNotNull(records);
        assertEquals(1, records.size());
    ...
    public void validInvalidMethod() {
        RecordParser parser = new RepoRecordParser();
        String line = ",\"17\",\"1423611312727\",,\"repo-prod-76-0.prod.sagebase.org\",\"33860\",\"Synpase-Java-Client/2015-01-30-1577-40e5630  Synapse-Web-Client/76.0-2-g5f246c4\",\"domain=SYNAPSE\",\"6a7616fd-9549-432f-9174-8005ba0d5665\",,\"/repo/v1/entity/syn3163713/table/upload/csv/preview/async/start\",\"3323072\",,\"2015-02-10\",\"GET\",\"043ad075351c10aa:4ea2e7a8:14b461f6975:-7ffd\",\"000000076\",\"prod\",\"true\",\"201\"";
        Reader reader = new StringReader(line);
        List<AccessRecord> records = parser.parse(reader);
        assertNotNull(records);
        assertEquals(1, records.size());
