...
@Component("uploadTableMetric")
public class UploadTableMetric extends UniqueCountMetric<AccessRecord, String> {
    ...
    private final List<RecordFilter<AccessRecord>> filters = 
            Collections.unmodifiableList(Arrays.asList( new ProdFilter(), new UriUploadTableFilter(), new MethodFilter("POST")));
