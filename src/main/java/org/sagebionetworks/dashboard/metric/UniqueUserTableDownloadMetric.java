...
/**
 * This metric captures the number of unique users that downloaded a table.
 */
@Component("uniqueUserTableDownloadMetric")
public class UniqueUserTableDownloadMetric extends UniqueCountMetric<AccessRecord, String> {
