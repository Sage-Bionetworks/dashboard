...
/**
 * This metric captures the number of unique users that updated a table.
 */
@Component("uniqueUserTableUpdateMetric")
public class UniqueUserTableUpdateMetric extends UniqueCountMetric<AccessRecord, String> {
