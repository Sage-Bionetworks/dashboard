...
public class MetricRegistry {
    ...
    public MetricRegistry(
            Collection<TimeSeriesToWrite> tsToWrite,
            Collection<UniqueCountToWrite> ucToWrite,
            NameIdDao nameIdDao) {
    ...
    private void createMetricToRead(
            String name,
            String description,
            String metricToWriteName,
            MetricType metricType,
            Aggregation aggregation,
            Statistic statistic,
            DateTime defaultStart,
            DateTime defaultEnd,
            List<MetricToRead> list,
            Map<String, MetricToRead> map) {
